...
_Again, Gender works as a confounder. The paradox that the effect changes when analyzing the aggreagte versus specific groups is known as [Simpson's paradox](https://de.wikipedia.org/wiki/Simpson-Paradoxon)._
